...
void Foam::dsmcFields::write()
{
    if (active_)
    {
        ...
        if (min(mag(rhoNMean)).value() > VSMALL)
        {
            ...
            Info(log_)<< "    Calculating UMean field" << endl;
            ...
            Info(log_)<< "    Calculating translationalT field" << endl;
            ...
            Info(log_)<< "    Calculating internalT field" << endl;
            ...
            Info(log_)<< "    Calculating overallT field" << endl;
            ...
            Info(log_)<< "    Calculating pressure field" << endl;
            volScalarField p
            (
                IOobject
                (
            ...
            Info(log_)<< "    " << type() << " written" << nl << endl;
        }
        else
        {
            Info(log_)
