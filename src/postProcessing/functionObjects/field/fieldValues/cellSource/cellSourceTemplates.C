...
template<class Type>
Foam::tmp<Foam::Field<Type> > Foam::fieldValues::cellSource::getFieldValues
(
...
) const
{
    ...
    if (mustGet)
    {
        ...
        (
            ...
            "Foam::fieldValues::cellSource::getFieldValues"
            "("
                "const word&, "
                "const bool"
            ") const"
...
) const
{
    ...
    switch (operation_)
    {
        ...
        case opCoV:
        {
            ...
            Type meanValue = gSum(values*V)/sumV;
...
)
{
    ...
    if (ok)
    {
        ...
        // apply scale factor weight field
        values *= scaleFactor_;
        if (weightField.size())
        {
            values *= weightField;
