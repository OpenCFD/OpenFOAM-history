...
//void Foam::localIOdictionary::readFile(const bool masterOnly)
//{
//    if (Pstream::master() || !masterOnly)
//    {
//        if (debug)
//        {
//            Pout<< "localIOdictionary : Reading " << objectPath()
//                << " from file " << endl;
//        }
//
...
//        {
//            Sout<< nl
//                << "--- localIOdictionary " << name()
//                << ' ' << objectPath() << ":" << nl;
//            writeHeader(Sout);
//            writeData(Sout);
//            Sout<< "--- End of localIOdictionary " << name() << nl << endl;
//        }
//    }
//
...
//                IOstream::ASCII
//            );
//            localIOdictionary::readData(fromAbove);
//        }
//
...
//            if (debug)
//            {
//                Pout<< "localIOdictionary : Sending " << objectPath()
...
//                IOstream::ASCII
//            );
//            localIOdictionary::writeData(toBelow);
//        }
//    }
//}
...
bool Foam::localIOdictionary::readData(Istream& is)
{
    is >> *this;
...
bool Foam::localIOdictionary::writeData(Ostream& os) const
{
