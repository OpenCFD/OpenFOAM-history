...
usage(const char* progName)
{
	...
	"-v, --version             Show CosExternalizationContainment Service Factories version.\n"
	"-n, --with-naming         Try to register CosExternalizationContainment Service with Naming Service.\n"
	"-t, --with-trading        Try to register CosExternalizationContainment Service with Trading Service.\n"
...
int main( int argc, char *argv[] )
{
    ...
    idefs_contains->add ("IDL:omg.org/CosCompoundExternalization/Node:1.0");

    InterfaceDefsHelper* idefs_containedin = new InterfaceDefsHelper (orb);
    idefs_containedin->add ("IDL:omg.org/CosCompoundExternalization/Node:1.0"); 

    RoleFactory_impl<ExternalizationContainsRole_impl>* contains_role_factory 
	= new RoleFactory_impl<ExternalizationContainsRole_impl>;
    ...
    RoleFactory_impl<ExternalizationContainedInRole_impl>* containedin_role_factory 
	= new RoleFactory_impl<ExternalizationContainedInRole_impl>;
	...
	= PortableServer::string_to_ObjectId ("ExternalizationContainsRole_impl");
    PortableServer::ObjectId_var containedin_id 
	= PortableServer::string_to_ObjectId ("ExternalizationContainedInRole_impl");



    NamedRoleTypesHelper*
	nrth_containment = new NamedRoleTypesHelper (orb);
    nrth_containment->add ("IDL:omg.org/CosExternalizationContainment/ContainsRole:1.0", 
			   "ExternalizationContainsRole");
    nrth_containment->add ("IDL:omg.org/CosExternalizationContainment/ContainedInRole:1.0", 
			   "ExternalizationContainedInRole");


    RelationshipFactory_impl<ExternalizationContainment_impl>* containment_factory 
	= new RelationshipFactory_impl<ExternalizationContainment_impl> (orb);
	...
	= PortableServer::string_to_ObjectId ("ExternalizationContainment_impl");
	...
	switch (type)
	{
		...
		case RegisterHelper::trading:
		{
			...
			CosNaming::Name contains_id(4),contained_id(4),containment_id(4);
			...
			contains_id[0].id = CORBA::string_dup( "::CosCompoundExternalization::Role" );
			...
			contains_id[2].id = CORBA::string_dup( "::CosExternalizationContainment::ContainsRole" );
			...
			contained_id[0].id = CORBA::string_dup( "::CosCompoundExternalization::Role" );
			...
			contained_id[2].id = CORBA::string_dup( "::CosExternalizationContainment::ContainedInRole" );
			...
			containment_id[0].id = CORBA::string_dup( "::CosCompoundExternalization::Relationship" );
			...
			containment_id[2].id = CORBA::string_dup( "::CosExternalizationContainment::Relationship" );
