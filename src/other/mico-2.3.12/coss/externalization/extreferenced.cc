...
usage(const char* progName)
{
	...
	"-v, --version             Show CosExternalizationReference Service Factories version.\n"
...
int main( int argc, char *argv[] )
{
    ...
    idefs_references->add ("IDL:omg.org/CosCompoundExternalization/Node:1.0");

    InterfaceDefsHelper* idefs_referencedby = new InterfaceDefsHelper (orb);
    idefs_referencedby->add ("IDL:omg.org/CosCompoundExternalization/Node:1.0");


    RoleFactory_impl<ExternalizationReferencesRole_impl>* references_role_factory 
	= new RoleFactory_impl<ExternalizationReferencesRole_impl>;
    ...
    RoleFactory_impl<ExternalizationReferencedByRole_impl>* referencedby_role_factory 
	= new RoleFactory_impl<ExternalizationReferencedByRole_impl>;
	...
	= PortableServer::string_to_ObjectId ("ExternalizationReferencesRole_impl");
    PortableServer::ObjectId_var referencedby_id 
	= PortableServer::string_to_ObjectId ("ExternalizationReferencedByRole_impl");

    NamedRoleTypesHelper*
	nrth_reference = new NamedRoleTypesHelper (orb);
    nrth_reference->add ("IDL:omg.org/CosExternalizationReference/ReferencesRole:1.0", 
			 "ExternalizationReferencesRole");
    nrth_reference->add ("IDL:omg.org/CosExternalizationReference/ReferencedByRole:1.0", 
			 "ExternalizationReferencedByRole");
  

    RelationshipFactory_impl<ExternalizationReference_impl>* reference_factory 
	= new RelationshipFactory_impl<ExternalizationReference_impl> (orb);
	...
	= PortableServer::string_to_ObjectId ("ExternalizationReference_impl");
	...
	switch (type)
    {
		...
		case RegisterHelper::trading:
		{
			...
			CosNaming::Name references_id(4),referencedby_id(4),reference_id(4);
			...
			references_id[0].id = CORBA::string_dup( "::CosCompoundExternalization::Role" );
			...
			references_id[2].id = CORBA::string_dup( "::CosExternalizationReference::ReferencesRole" );
			...
			referencedby_id[0].id = CORBA::string_dup( "::CosCompoundExternalization::Role" );
			...
			referencedby_id[2].id = CORBA::string_dup( "::CosExternalizationReference::ReferencedByRole" );
			...
			reference_id[0].id = CORBA::string_dup( "::CosCompoundExternalization::Relationship" );
			...
			reference_id[2].id = CORBA::string_dup( "::CosExternalizationReference::Relationship" );
