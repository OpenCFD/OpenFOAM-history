...
usage(const char* progName)
{
	...
	"-v, --version             Show CosLifeCycle::FactoryFinder Service version.\n"
...
int main( int argc, char *argv[] )
{
    ...
    FactoryFinder_impl* factoryfinder =
	new FactoryFinder_impl(orb,type);

    PortableServer::ObjectId_var factoryfinder_id 
	= PortableServer::string_to_ObjectId ("FactoryFinder_impl");

    poa->activate_object_with_id (*factoryfinder_id, factoryfinder);
