...
usage(const char* progName)
{
	...
	"-v, --version             Show CosCompoundLifeCycle::PropagationCriteriaFactory Service version.\n"
	;
}
...
int main( int argc, char *argv[] )
{
    ...
    CosCompoundLifeCycle_impl::PropagationCriteriaFactory_impl* pcf =
	new CosCompoundLifeCycle_impl::PropagationCriteriaFactory_impl;
