...
int main( int argc, char *argv[] )
{
  ...
  idefs_base->add ("IDL:omg.org/CosCompoundLifeCycle/Node:1.0");

  InterfaceDefsHelper* idefs_derived1 = new InterfaceDefsHelper (orb);
  idefs_derived1->add ("IDL:omg.org/CosCompoundLifeCycle/Node:1.0"); 
  ...
  idefs_derived2->add ("IDL:omg.org/CosCompoundLifeCycle/Node:1.0"); 
