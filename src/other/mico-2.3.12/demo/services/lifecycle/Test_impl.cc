...
#endif
    factory_id_[2].id = CORBA::string_dup("::Test::BaseRole");
}



BaseRole_impl::BaseRole_impl (CosRelationships::RelatedObject_ptr obj)
  : CosCompoundLifeCycle_impl::Role_impl (obj),
    POA_Test::BaseRole ()
{
#if DEBUG
...
{
    factory_id_[2].id = CORBA::string_dup("::Test::DerivedRole1");
}
...
{
    factory_id_[2].id = CORBA::string_dup("::Test::DerivedRole2");
}
...
{
    factory_id_[2].id = CORBA::string_dup("::Test::TestRelationship");
}



TestRelationship_impl::TestRelationship_impl (CosRelationships::NamedRoles nr)
  : CosCompoundLifeCycle_impl::Relationship_impl (nr),
    POA_Test::TestRelationship ()
{
    factory_id_[2].id = CORBA::string_dup("::Test::TestRelationship");
}
