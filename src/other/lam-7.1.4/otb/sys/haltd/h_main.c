 ...
 * $HEADER$
 *
 * $Id: h_main.c,v 1.15 2003/09/27 05:16:16 brbarret Exp $
 * 
 *	Function:	- halt server, for shutting down LAM
 */
...
/*
 * server loop
 * Kinda overkill, since one execution will terminate the server... :-)
 */
	for (;;) {
