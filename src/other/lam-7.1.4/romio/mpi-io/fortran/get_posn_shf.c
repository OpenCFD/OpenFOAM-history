...
/* 
 *   $Id: get_posn_shf.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
#pragma weak MPI_FILE_GET_POSITION_SHARED = PMPI_FILE_GET_POSITION_SHARED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_position_shared__(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
#pragma weak mpi_file_get_position_shared__ = pmpi_file_get_position_shared__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_position_shared(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
#pragma weak mpi_file_get_position_shared = pmpi_file_get_position_shared
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_position_shared_(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
