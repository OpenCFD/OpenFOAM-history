...
/* 
 *   $Id: seek_shf.c,v 1.4 2003/06/23 18:56:54 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_SEEK_SHARED(MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr );
#pragma weak MPI_FILE_SEEK_SHARED = PMPI_FILE_SEEK_SHARED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_seek_shared__(MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr );
#pragma weak mpi_file_seek_shared__ = pmpi_file_seek_shared__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_seek_shared(MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr );
#pragma weak mpi_file_seek_shared = pmpi_file_seek_shared
#else
extern FORTRAN_API void FORT_CALL mpi_file_seek_shared_(MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr );
