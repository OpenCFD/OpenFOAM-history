...
/* 
 *   $Id: iread_atf.c,v 1.5 2003/06/24 20:12:46 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_IREAD_AT(MPI_Fint *fh,MPI_Offset *offset,void *buf,
                      int *count,MPI_Fint *datatype,
                                                     MPI_Fint *request, int *ierr );
#pragma weak MPI_FILE_IREAD_AT = PMPI_FILE_IREAD_AT
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_iread_at__(MPI_Fint *fh,MPI_Offset *offset,void *buf,
                      int *count,MPI_Fint *datatype,
                                                     MPI_Fint *request, int *ierr );
...
#pragma weak mpi_file_iread_at = pmpi_file_iread_at
#else
extern FORTRAN_API void FORT_CALL mpi_file_iread_at_(MPI_Fint *fh,MPI_Offset *offset,void *buf,
                      int *count,MPI_Fint *datatype,
                                                     MPI_Fint *request, int *ierr );
