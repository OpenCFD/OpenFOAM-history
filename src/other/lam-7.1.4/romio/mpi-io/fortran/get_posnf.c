...
/* 
 *   $Id: get_posnf.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_GET_POSITION(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
#pragma weak MPI_FILE_GET_POSITION = PMPI_FILE_GET_POSITION
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_position__(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
#pragma weak mpi_file_get_position__ = pmpi_file_get_position__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_position(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
#pragma weak mpi_file_get_position = pmpi_file_get_position
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_position_(MPI_Fint *fh, MPI_Offset *offset, int *ierr );
