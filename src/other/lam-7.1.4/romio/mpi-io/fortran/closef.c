...
/* 
 *   $Id: closef.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_CLOSE(MPI_Fint *fh, int *ierr );
#pragma weak MPI_FILE_CLOSE = PMPI_FILE_CLOSE
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_close__(MPI_Fint *fh, int *ierr );
#pragma weak mpi_file_close__ = pmpi_file_close__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_close(MPI_Fint *fh, int *ierr );
#pragma weak mpi_file_close = pmpi_file_close
#else
extern FORTRAN_API void FORT_CALL mpi_file_close_(MPI_Fint *fh, int *ierr );
