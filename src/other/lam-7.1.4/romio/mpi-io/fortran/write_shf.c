...
/* 
 *   $Id: write_shf.c,v 1.5 2003/06/24 20:12:47 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE_SHARED(MPI_Fint *fh,void *buf,int *count,
                                                         MPI_Fint *datatype,MPI_Status *status, int *ierr );
#pragma weak MPI_FILE_WRITE_SHARED = PMPI_FILE_WRITE_SHARED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_shared__(MPI_Fint *fh,void *buf,int *count,
                                                         MPI_Fint *datatype,MPI_Status *status, int *ierr );
...
#pragma weak mpi_file_write_shared = pmpi_file_write_shared
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_shared_(MPI_Fint *fh,void *buf,int *count,
                                                         MPI_Fint *datatype,MPI_Status *status, int *ierr );
