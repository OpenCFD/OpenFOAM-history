...
/* 
 *   $Id: set_errhf.c,v 1.4 2003/06/23 18:56:54 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_SET_ERRHANDLER(MPI_Fint *fh, MPI_Fint *err_handler, int *ierr);
#pragma weak MPI_FILE_SET_ERRHANDLER = PMPI_FILE_SET_ERRHANDLER
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_set_errhandler__(MPI_Fint *fh, MPI_Fint *err_handler, int *ierr);
#pragma weak mpi_file_set_errhandler__ = pmpi_file_set_errhandler__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_set_errhandler(MPI_Fint *fh, MPI_Fint *err_handler, int *ierr);
#pragma weak mpi_file_set_errhandler = pmpi_file_set_errhandler
#else
extern FORTRAN_API void FORT_CALL mpi_file_set_errhandler_(MPI_Fint *fh, MPI_Fint *err_handler, int *ierr);
