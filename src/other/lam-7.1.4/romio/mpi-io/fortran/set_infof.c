...
/* 
 *   $Id: set_infof.c,v 1.4 2003/06/23 18:56:54 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_SET_INFO(MPI_Fint *fh, MPI_Fint *info, int *ierr );
#pragma weak MPI_FILE_SET_INFO = PMPI_FILE_SET_INFO
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_set_info__(MPI_Fint *fh, MPI_Fint *info, int *ierr );
#pragma weak mpi_file_set_info__ = pmpi_file_set_info__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_set_info(MPI_Fint *fh, MPI_Fint *info, int *ierr );
#pragma weak mpi_file_set_info = pmpi_file_set_info
#else
extern FORTRAN_API void FORT_CALL mpi_file_set_info_(MPI_Fint *fh, MPI_Fint *info, int *ierr );
