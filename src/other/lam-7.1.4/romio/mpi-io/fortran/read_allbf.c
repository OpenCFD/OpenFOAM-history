...
/* 
 *   $Id: read_allbf.c,v 1.5 2003/06/24 20:12:47 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_ALL_BEGIN(MPI_Fint *fh,void *buf,int *count,
                      MPI_Fint *datatype, int *ierr );
#pragma weak MPI_FILE_READ_ALL_BEGIN = PMPI_FILE_READ_ALL_BEGIN
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_all_begin__(MPI_Fint *fh,void *buf,int *count,
                      MPI_Fint *datatype, int *ierr );
...
#pragma weak mpi_file_read_all_begin = pmpi_file_read_all_begin
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_all_begin_(MPI_Fint *fh,void *buf,int *count,
                      MPI_Fint *datatype, int *ierr );
