...
/* 
 *   $Id: set_viewf.c,v 1.7 2003/06/24 20:12:47 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_SET_VIEW(MPI_Fint *fh,MPI_Offset *disp,MPI_Fint *etype,
   MPI_Fint *filetype,char *datarep,MPI_Fint *info, int *ierr,
                                                     int str_len );
#pragma weak MPI_FILE_SET_VIEW = PMPI_FILE_SET_VIEW
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_set_view__(MPI_Fint *fh,MPI_Offset *disp,MPI_Fint *etype,
   MPI_Fint *filetype,char *datarep,MPI_Fint *info, int *ierr,
                                                     int str_len );
...
#pragma weak mpi_file_set_view = pmpi_file_set_view
#else
extern FORTRAN_API void FORT_CALL mpi_file_set_view_(MPI_Fint *fh,MPI_Offset *disp,MPI_Fint *etype,
   MPI_Fint *filetype,char *datarep,MPI_Fint *info, int *ierr,
                                                     int str_len );
   ...
   int str_len )
{
    ...
    lam_strncpy(newstr, datarep, real_len);
    newstr[real_len] = '\0';
