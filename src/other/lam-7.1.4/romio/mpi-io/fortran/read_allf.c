...
/* 
 *   $Id: read_allf.c,v 1.5 2003/06/24 20:12:47 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_ALL(MPI_Fint *fh,void *buf,int *count,
                      MPI_Fint *datatype,MPI_Status *status, int *ierr );
#pragma weak MPI_FILE_READ_ALL = PMPI_FILE_READ_ALL
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_all__(MPI_Fint *fh,void *buf,int *count,
                      MPI_Fint *datatype,MPI_Status *status, int *ierr );
...
#pragma weak mpi_file_read_all = pmpi_file_read_all
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_all_(MPI_Fint *fh,void *buf,int *count,
                      MPI_Fint *datatype,MPI_Status *status, int *ierr );
