...
/* 
 *   $Id: get_amodef.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_GET_AMODE(MPI_Fint *fh,int *amode, int *ierr );
#pragma weak MPI_FILE_GET_AMODE = PMPI_FILE_GET_AMODE
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_amode__(MPI_Fint *fh,int *amode, int *ierr );
#pragma weak mpi_file_get_amode__ = pmpi_file_get_amode__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_amode(MPI_Fint *fh,int *amode, int *ierr );
#pragma weak mpi_file_get_amode = pmpi_file_get_amode
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_amode_(MPI_Fint *fh,int *amode, int *ierr );
