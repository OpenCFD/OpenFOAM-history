...
/* 
 *   $Id: get_groupf.c,v 1.5 2003/06/24 20:12:46 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_GET_GROUP(MPI_Fint *fh,MPI_Fint *group, int *ierr );
#pragma weak MPI_FILE_GET_GROUP = PMPI_FILE_GET_GROUP
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_group__(MPI_Fint *fh,MPI_Fint *group, int *ierr );
#pragma weak mpi_file_get_group__ = pmpi_file_get_group__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_group(MPI_Fint *fh,MPI_Fint *group, int *ierr );
#pragma weak mpi_file_get_group = pmpi_file_get_group
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_group_(MPI_Fint *fh,MPI_Fint *group, int *ierr );
