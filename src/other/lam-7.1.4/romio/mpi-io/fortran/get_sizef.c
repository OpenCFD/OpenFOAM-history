...
/* 
 *   $Id: get_sizef.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_GET_SIZE(MPI_Fint *fh,MPI_Offset *size, int *ierr );
#pragma weak MPI_FILE_GET_SIZE = PMPI_FILE_GET_SIZE
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_size__(MPI_Fint *fh,MPI_Offset *size, int *ierr );
#pragma weak mpi_file_get_size__ = pmpi_file_get_size__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_size(MPI_Fint *fh,MPI_Offset *size, int *ierr );
#pragma weak mpi_file_get_size = pmpi_file_get_size
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_size_(MPI_Fint *fh,MPI_Offset *size, int *ierr );
