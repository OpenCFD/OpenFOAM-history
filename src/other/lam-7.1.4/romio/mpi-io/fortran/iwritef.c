...
/* 
 *   $Id: iwritef.c,v 1.5 2003/06/24 20:12:47 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_IWRITE(MPI_Fint *fh,void *buf,int *count,
                                                   MPI_Fint *datatype,MPI_Fint *request, int *ierr );
#pragma weak MPI_FILE_IWRITE = PMPI_FILE_IWRITE
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_iwrite__(MPI_Fint *fh,void *buf,int *count,
                                                   MPI_Fint *datatype,MPI_Fint *request, int *ierr );
...
#pragma weak mpi_file_iwrite = pmpi_file_iwrite
#else
extern FORTRAN_API void FORT_CALL mpi_file_iwrite_(MPI_Fint *fh,void *buf,int *count,
                                                   MPI_Fint *datatype,MPI_Fint *request, int *ierr );
