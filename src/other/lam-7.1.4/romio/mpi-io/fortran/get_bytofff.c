...
/* 
 *   $Id: get_bytofff.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_GET_BYTE_OFFSET(MPI_Fint *fh,MPI_Offset *offset,MPI_Offset *disp, int *ierr );
#pragma weak MPI_FILE_GET_BYTE_OFFSET = PMPI_FILE_GET_BYTE_OFFSET
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_byte_offset__(MPI_Fint *fh,MPI_Offset *offset,MPI_Offset *disp, int *ierr );
#pragma weak mpi_file_get_byte_offset__ = pmpi_file_get_byte_offset__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_byte_offset(MPI_Fint *fh,MPI_Offset *offset,MPI_Offset *disp, int *ierr );
#pragma weak mpi_file_get_byte_offset = pmpi_file_get_byte_offset
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_byte_offset_(MPI_Fint *fh,MPI_Offset *offset,MPI_Offset *disp, int *ierr );
