...
/* 
 *   $Id: write_ordbf.c,v 1.5 2003/06/24 20:12:47 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE_ORDERED_BEGIN(MPI_Fint *fh,void *buf,int *count,
                                         MPI_Fint *datatype, int *ierr );
#pragma weak MPI_FILE_WRITE_ORDERED_BEGIN = PMPI_FILE_WRITE_ORDERED_BEGIN
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_ordered_begin__(MPI_Fint *fh,void *buf,int *count,
                                           MPI_Fint *datatype, int *ierr );
...
#pragma weak mpi_file_write_ordered_begin = pmpi_file_write_ordered_begin
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_ordered_begin_(MPI_Fint *fh,void *buf,int *count,
                                          MPI_Fint *datatype, int *ierr );
