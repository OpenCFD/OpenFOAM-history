...
/* 
 *   $Id: rd_atallef.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_AT_ALL_END(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
#pragma weak MPI_FILE_READ_AT_ALL_END = PMPI_FILE_READ_AT_ALL_END
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_at_all_end__(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
#pragma weak mpi_file_read_at_all_end__ = pmpi_file_read_at_all_end__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_at_all_end(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
#pragma weak mpi_file_read_at_all_end = pmpi_file_read_at_all_end
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_at_all_end_(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
