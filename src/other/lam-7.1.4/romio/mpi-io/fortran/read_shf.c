...
/* 
 *   $Id: read_shf.c,v 1.5 2003/06/24 20:12:47 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_SHARED(MPI_Fint *fh,void *buf,int *count,
                                                        MPI_Fint *datatype,MPI_Status *status, int *ierr );
#pragma weak MPI_FILE_READ_SHARED = PMPI_FILE_READ_SHARED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_shared__(MPI_Fint *fh,void *buf,int *count,
                                                        MPI_Fint *datatype,MPI_Status *status, int *ierr );
...
#pragma weak mpi_file_read_shared = pmpi_file_read_shared
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_shared_(MPI_Fint *fh,void *buf,int *count,
                                                        MPI_Fint *datatype,MPI_Status *status, int *ierr );
