...
/* 
 *   $Id: iowaitf.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPIO_WAIT(MPI_Fint *request,MPI_Status *status, int *ierr );
#pragma weak MPIO_WAIT = PMPIO_WAIT
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpio_wait__(MPI_Fint *request,MPI_Status *status, int *ierr );
#pragma weak mpio_wait__ = pmpio_wait__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpio_wait(MPI_Fint *request,MPI_Status *status, int *ierr );
#pragma weak mpio_wait = pmpio_wait
#else
extern FORTRAN_API void FORT_CALL mpio_wait_(MPI_Fint *request,MPI_Status *status, int *ierr );
