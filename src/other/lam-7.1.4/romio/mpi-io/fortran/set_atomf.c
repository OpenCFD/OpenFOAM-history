...
/* 
 *   $Id: set_atomf.c,v 1.4 2003/06/23 18:56:54 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_SET_ATOMICITY(MPI_Fint *fh,int *flag, int *ierr );
#pragma weak MPI_FILE_SET_ATOMICITY = PMPI_FILE_SET_ATOMICITY
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_set_atomicity__(MPI_Fint *fh,int *flag, int *ierr );
#pragma weak mpi_file_set_atomicity__ = pmpi_file_set_atomicity__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_set_atomicity(MPI_Fint *fh,int *flag, int *ierr );
#pragma weak mpi_file_set_atomicity = pmpi_file_set_atomicity
#else
extern FORTRAN_API void FORT_CALL mpi_file_set_atomicity_(MPI_Fint *fh,int *flag, int *ierr );
