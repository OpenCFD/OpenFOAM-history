...
/* 
 *   $Id: write_ordef.c,v 1.4 2003/06/23 18:56:54 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE_ORDERED_END(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
#pragma weak MPI_FILE_WRITE_ORDERED_END = PMPI_FILE_WRITE_ORDERED_END
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_ordered_end__(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
#pragma weak mpi_file_write_ordered_end__ = pmpi_file_write_ordered_end__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_ordered_end(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
#pragma weak mpi_file_write_ordered_end = pmpi_file_write_ordered_end
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_ordered_end_(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr );
