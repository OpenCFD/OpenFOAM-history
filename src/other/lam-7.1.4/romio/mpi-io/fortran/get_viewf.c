...
/* 
 *   $Id: get_viewf.c,v 1.7 2003/06/24 20:12:46 jsquyres Exp $    
 *
...
/* LAM lam_strncpy(), because some platforms have a broken strncpy.
   <sigh> */
...
extern FORTRAN_API void FORT_CALL MPI_FILE_GET_VIEW(MPI_Fint *fh,MPI_Offset *disp,MPI_Fint *etype,
                                                     MPI_Fint *filetype,char *datarep, int *ierr, int str_len );
#pragma weak MPI_FILE_GET_VIEW = PMPI_FILE_GET_VIEW
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_view__(MPI_Fint *fh,MPI_Offset *disp,MPI_Fint *etype,
                                                     MPI_Fint *filetype,char *datarep, int *ierr, int str_len );
...
#pragma weak mpi_file_get_view = pmpi_file_get_view
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_view_(MPI_Fint *fh,MPI_Offset *disp,MPI_Fint *etype,
                                                     MPI_Fint *filetype,char *datarep, int *ierr, int str_len );
   ...
   MPI_Fint *filetype,char *datarep, int *ierr, int str_len )
{
    ...
    *ierr = MPI_File_get_view(fh_c, disp, &etype_c, &filetype_c, tmprep);
    ...
    if (tmpreplen <= str_len) {
        lam_strncpy(datarep, tmprep, tmpreplen);
        ...
        /* not enough space */
        lam_strncpy(datarep, tmprep, str_len);
