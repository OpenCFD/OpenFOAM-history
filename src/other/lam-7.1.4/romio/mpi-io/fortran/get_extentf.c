...
/* 
 *   $Id: get_extentf.c,v 1.5 2003/06/24 20:12:46 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_GET_TYPE_EXTENT(MPI_Fint *fh,MPI_Fint *datatype,
                                                            MPI_Fint *extent, int *ierr );
#pragma weak MPI_FILE_GET_TYPE_EXTENT = PMPI_FILE_GET_TYPE_EXTENT
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_type_extent__(MPI_Fint *fh,MPI_Fint *datatype,
                                                            MPI_Fint *extent, int *ierr );
...
#pragma weak mpi_file_get_type_extent = pmpi_file_get_type_extent
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_type_extent_(MPI_Fint *fh,MPI_Fint *datatype,
                                                            MPI_Fint *extent, int *ierr );
