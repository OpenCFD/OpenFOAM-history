...
/* 
 *   $Id: get_infof.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_(MPI_Fint *fh, MPI_Fint *info_used, int *ierr );
#pragma weak MPI_FILE_GET_INFO = PMPI_FILE_GET_INFO
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_info__(MPI_Fint *fh, MPI_Fint *info_used, int *ierr );
#pragma weak mpi_file_get_info__ = pmpi_file_get_info__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_get_info(MPI_Fint *fh, MPI_Fint *info_used, int *ierr );
#pragma weak mpi_file_get_info = pmpi_file_get_info
#else
extern FORTRAN_API void FORT_CALL mpi_file_get_info_(MPI_Fint *fh, MPI_Fint *info_used, int *ierr );
