...
/* 
 *   $Id: fsyncf.c,v 1.4 2003/06/23 18:56:53 jsquyres Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_SYNC(MPI_Fint *fh, int *ierr );
#pragma weak MPI_FILE_SYNC = PMPI_FILE_SYNC
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_sync__(MPI_Fint *fh, int *ierr );
#pragma weak mpi_file_sync__ = pmpi_file_sync__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_sync(MPI_Fint *fh, int *ierr );
#pragma weak mpi_file_sync = pmpi_file_sync
#else
extern FORTRAN_API void FORT_CALL mpi_file_sync_(MPI_Fint *fh, int *ierr );
