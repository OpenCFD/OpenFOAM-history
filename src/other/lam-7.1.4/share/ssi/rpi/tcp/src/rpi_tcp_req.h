 ...
 * $HEADER$
 *
 * $Id: rpi_tcp_req.h,v 1.2 2002/10/09 21:00:39 brbarret Exp $
 *
 *	Function:	- TCP client-to-client interface header
 */

#ifndef LAM_SSI_RPI_TCP_REQ_H
#define LAM_SSI_RPI_TCP_REQ_H
